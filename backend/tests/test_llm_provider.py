...
class LlmProviderTests(unittest.TestCase):
    ...
    def test_deepseek_config_accepts_vercel_dashboard_mixed_case_name(self):
        from app.llm_provider import resolve_llm_config
        ...
        with patch.dict(
            ...
            {
                "MODEL_PROVIDER": "deepseek",
                "DeepSeek": "mixed-case-ds-test-key",
            },
            clear=True,
        ):
            config = resolve_llm_config()

        self.assertEqual(config.api_key, "mixed-case-ds-test-key")
